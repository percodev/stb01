...
```
Выгрузка архива *.tar.gz с файлами диагностической БД осуществляется аналогично выгрузке лог-архива ([Сервис](/Сервис.md)), с добавлением фильтра по времени следующим образом:
